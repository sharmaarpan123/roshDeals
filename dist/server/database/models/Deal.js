    ...
    platForm: {
        ...
        validate: {
            validator: async function (platFormId) {
                const platForm = await mongoose.models.PlatForm.findById(platFormId).lean();
                return !!platForm;
            },
    ...
    dealCategory: {
        ...
        validate: {
            validator: async function (DealCategoryId) {
                const DealCategory = await mongoose.models.DealCategory.findById(DealCategoryId).lean();
                return !!DealCategory;
            },
